...
class _ChatInboxState extends State<ChatInbox> {
  List<InboxItem> inboxItems = [
    InboxItem('Jane Cooper', 'manhhachkt08@gmail.com', 'assets/images/logo_small_icon_only_inverted.png', false),
    InboxItem('Jane Cooper', 'manhhachkt08@gmail.com', 'assets/images/logo_small_icon_only_inverted.png', false),
    InboxItem('Jane Cooper', 'manhhachkt08@gmail.com', 'assets/images/logo_small_icon_only_inverted.png', false),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BarWithReturn(context, 'Inbox'),
      body: Padding(
...
Container(
        ...
        onPressed: () {
          // Handle search action
            ...
            for (int i = 0; i < inboxItems.length; i++) ...[
              ...
              if (i < inboxItems.length - 1) SizedBox(height: 2), // Add spacing between items
            ],
          ],
        ),
      ),
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 15), // Added horizontal padding
      child: Row(
        children: [
          Stack(
            children: [
